<?php
/* 
 * Form to edit a specific alumni's information.
 * 
 * @author: Robert Vines
 */
...
<div id='page'>
    <h1>Edit Alumni</h1>
        <div id="body">
            <form method='post' action="/AlumniTracker/Controller/EditAlumniController.php">
                <table id="formTable">
                   <tr>
                   ...
                   <tr>
                        <td style=>Primary Email:</td> <td><input type="email" name="FirstEmail" value="<?php echo $primEmail; ?>" /></td>
                   ...
                   <tr>
                       ...
                       <td><select name="MajorType" required>
                                <?php 
                                    $sql = "SELECT DISTINCT Type FROM degree WHERE DegreeID=".$majorId;
                                    $result = $pdo->query($sql);
                                    while ($val = $result->fetch()):
                                    $degreeType = $val['Type'];
