    ...
    <div id="body">
        ...
        {               
            ...
            <table id="information">
                ...
                <tr>
                    <td colspan="5">
                        <a href="EditAccountForm.php?edit_account=<?php echo $empID ?>"><button type="button">Edit</button></a>
                        <a href="EditAccount.php?delete_account=<?php echo $empID ?>" onclick="return confirm('Are you sure you want to delete this Account?');"><button type="button">Delete</button></a>
                    </td>
                </tr>
            </table>         
                <?php  
