    ...
    <h1>ALUMNI</h1>
        <div id="body">
            ...
            <table class="column2">
                        ...
                        <tr><td><a href="EditAlumni.php?edit_id=<?php echo $personId ?>"><button type="button">Edit</button></a></td>
                            <td><a href="Alumni.php?delete_id=<?php echo $personId ?>" onclick="return confirm('Are you sure you want to delete this Alumni?');"><button type="button">Delete</button></a></td></tr>
                    </table>          
